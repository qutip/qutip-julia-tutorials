...
other-links:
  - text: Run notebook in Binder
    href: "https://mybinder.org/v2/gh/qutip/qutip-julia-tutorials/notebooks/?urlpath=lab/tree/QuantumToolbox.jl/time_evolution/kerr.ipynb"
    icon: file-code
---
...
function plot_Fock_dist(tlist, states)
    ...
    n_col = size(states[1], 1) # the Hilbert space dimension
    n_row = length(tlist)
